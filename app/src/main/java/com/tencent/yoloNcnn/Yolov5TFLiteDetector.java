...
//    }
//
//    public boolean initialModel(String modelPath) {
//        try {
//            ByteBuffer tfliteModel = FileUtils.getLocalByteBuffer(modelPath);
//            tflite = new Interpreter(tfliteModel, options);
//            associatedAxisLabels = Param.yolo类名集合;
//            return true;
//        } catch (Exception e) {
//            e.printStackTrace();
//            return false;
...
//     * @return
//     */
//    public YoloV5Ncnn.Obj[] detect(Bitmap bitmap) {
//        List<YoloV5Ncnn.Obj> objData = new ArrayList<>();
...
//        }
//        for (Recognition nmsFilterBoxDuplicationRecognition : nmsFilterBoxDuplicationRecognitions) {
//            RectF rectF = nmsFilterBoxDuplicationRecognition.getLocation();
//
//            objData.add(new YoloV5Ncnn().new Obj(rectF.left, rectF.top, rectF.right, rectF.bottom, nmsFilterBoxDuplicationRecognition.getLabelName(), nmsFilterBoxDuplicationRecognition.getLabelScore()));
//        }
//        return objData.toArray(new YoloV5Ncnn.Obj[objData.size()]);
//    }
//
//    /**
//     * 非极大抑制
